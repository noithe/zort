...
client.login("ODYyMTAzNjIxMTgwMDYzNzU0.YOTekA.jQ2hldJgWsaUMvEYoQD1oRRNzlw");
const prefix = ".";
//Düzenlenecek tek kısım diğer kodlara ellemeyiniz.\\

client.on("ready", () => console.log("Hob nası tak diye buradayım!"));//Bot aktif olunca, konsola yazılcak mesaj. Tırnak içindeki yazıyı değiştirebilirsiniz.
